 ...
 * 
 * Authentication form with OAuth providers.
 */
...
export function LoginForm() {
  ...
  const { user, signInWithGoogle, signInWithMicrosoft, loading: authLoading } = useAuth();
      ...
      <div className="w-full max-w-md">
        ...
        <Card padding="lg" className="text-center">
          ...
          <p className="text-gray-600 dark:text-gray-400 mb-8">
            Sign in to access the ethical AI knowledge base
          </p>
          ...
          <p className="text-xs text-gray-500 dark:text-gray-400 mt-6">
            Guest users have limited access to features. Sign in to save your chat history and access admin features.
          </p>
        </Card>
        ...
        <p className="text-center text-xs text-gray-500 dark:text-gray-400 mt-6">
          ...
          and acknowledge our AI limitations.
        </p>
      </div>
    </div>
  );
